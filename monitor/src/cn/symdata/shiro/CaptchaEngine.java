...
public class CaptchaEngine extends ListImageCaptchaEngine {
	 ...
	 * 随机颜色
	 */
	private static final Color[] COLORS = new Color[] { new Color(0, 0, 0)};
	...
	protected void buildInitialFactories() {
		...
		BackgroundGenerator backgroundGenerator = new FunkyBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT);
